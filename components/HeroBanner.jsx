...
const HeroBanner = ({heroBanner}) => {
  return (
    ...
    display:"flex", justifyContent:"space-between",alignItems:"center", width:"100%", mt:0, height:"450px", position:"relative"}}>
      <Box sx={{ml:10, }}>
      ...
      mb:{xs:15, xl:5}}} variant="h1">{heroBanner.midText}</Typography>
        ...
        <Link style={{textDecoration:"none"}}   href={`/food/${heroBanner.food}`} >
